...
class Cache {
    ...
    /**
     * 缓存驱动
     * @var misterxin\\cache\interfaces\driver\Base
     */
    private $driver;
    ...
    public function __construct($type = '', $config = []) {
        ...
        if (!isset(self::$_drivers[$key])) {
            $class = '\\misterxin\\cache\\drivers\\' . ucwords(strtolower($type));
    ...
    /**
     * 获取缓存驱动实例
     * @return misterxin\\cache\interfaces\driver\Base
     */
