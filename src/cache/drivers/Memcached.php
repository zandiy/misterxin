...
use misterxin\cache\interfaces\driver\Base;
use misterxin\cache\interfaces\driver\Lock;
use misterxin\cache\interfaces\driver\Incr;
use misterxin\cache\interfaces\driver\Multi;
use \Exception;

class Memcached implements Base, Lock, Incr, Multi {

    use \misterxin\cache\traits\CacheDriver;
